...
$query = "SELECT * FROM found_items LIMIT " . $page_first_result . ',' . $results_per_page;  
$result = mysqli_query($mysqli, $query);  
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <link rel="stylesheet" type="text/css" href='cssfile/style_disp_foundtry.css' />
</head>
<body>
<div class="upper">
    <div class="navbar">
...
$count++;
if($page>=2) {   
  echo "<ab><a href='disp_found.php?page=".($page-1)."'>  Prev </a></ab>";   
}       
             
for ($i=1; $i<=$number_of_page; $i++) {   
  if ($i == $page) {   
        $pagLink .= "<ab><a class = 'active' href='disp_found.php?page=".$i."'>".$i." </a></ab>";   
    }               
    else  {   
        $pagLink .= "<ab><a href='disp_found.php?page=".$i."'>".$i." </a></ab>";     
    }   
};     
echo $pagLink;   

if($page<$number_of_page){   
    echo "<ab><a href='disp_found.php?page=".($page+1)."'>  Next </a></ab>";   
}  
?>
</div><!--page-->
