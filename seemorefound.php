...
<head>
    ...
    <link rel="stylesheet" type="text/css" href='cssfile/style_seemorefoundtry.css' />
</head>
<body>
<div class="upper">
    <div class="navbar">
...
$id = isset($_GET['id']) ? $_GET['id'] : null;
        $sql = "SELECT id, cat, sub_cat, loc, date , item_descp FROM found_items WHERE id='$id'";
        ...
        ?>
        <div class="caption">
        <p class="found"><?php echo "FOUND" ."<br>";?></p>
...
<div class="box2">
  ...
  <p class="message"> <?php echo "<a href='try2.php?id=$id'> Send Message </a>"?></p>
