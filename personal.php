...
$query="SELECT * from found_items WHERE cat = 'Personal Accessories' UNION ALL SELECT * FROM lost_items WHERE cat = 'Personal Accessories' ";
...
$sel="SELECT * from found_items WHERE cat = 'Personal Accessories' UNION ALL SELECT * FROM lost_items WHERE cat = 'Personal Accessories' ";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href='cssfile/style_pertry.css' />
</head>
<body>
<div class="upper">
    <div class="navbar">
...
$count++;
if($page>=2) {   
  echo "<ab><a href='personal.php?page=".($page-1)."'>  Prev </a></ab>";   
}       
             
for ($i=1; $i<=$number_of_page; $i++) {   
  if ($i == $page) {   
        $pagLink .= "<ab><a class = 'active' href='personal.php?page=".$i."'>".$i." </a></ab>";   
    }               
    else  {   
        $pagLink .= "<ab><a href='personal.php?page=".$i."'>".$i." </a></ab>";     
    }   
};     
echo $pagLink;   

if($page<$number_of_page){   
    echo "<ab><a href='personal.php?page=".($page+1)."'>  Next </a></ab>";   
}  
?>
</div>
<main>
<?php
  while($row=mysqli_fetch_assoc($result1)){?>
    ...
    <div class="card"> 
      <div class="caption"> <div class="id_trans">
