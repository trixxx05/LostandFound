...
$query="SELECT * from found_items WHERE cat = 'Electronics' UNION ALL SELECT * FROM lost_items WHERE cat = 'Electronics' ";
...
$sel="SELECT * from found_items WHERE cat = 'Electronics' UNION ALL SELECT * FROM lost_items WHERE cat = 'Electronics' ";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href='cssfile/style_electry.css' />
</head>
<body>
<div class="upper">
    <div class="navbar">
...
$count++;
if($page>=2) {   
  echo "<ab><a href='electronics.php?page=".($page-1)."'>  Prev </a></ab>";   
}       
             
for ($i=1; $i<=$number_of_page; $i++) {   
  if ($i == $page) {   
        $pagLink .= "<ab><a class = 'active' href='electronics.php?page=".$i."'>".$i." </a></ab>";   
    }               
    else  {   
        $pagLink .= "<ab><a href='electronics.php?page=".$i."'>".$i." </a></ab>";     
    }   
};     
echo $pagLink;   

if($page<$number_of_page){   
    echo "<ab><a href='electronics.php?page=".($page+1)."'>  Next </a></ab>";   
}  
?>
</div><!--page-->
<main>
